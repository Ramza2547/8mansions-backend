...
from api.views import FeedbackViewSet, InvoiceViewSet, UtilityCostViewSet, HistoryLogViewSet
...
router.register(r'history', HistoryLogViewSet, basename='history') # 👈 🎯 ย้ายออกมาต่อท้ายเพื่อนๆ ตรงนี้ครับ!
